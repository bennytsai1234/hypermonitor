...
class TrendChart extends StatelessWidget {
  ...
  final String? overrideSentiment; // 1:1 修正：允許外部傳入當前情緒
  ...
  Widget build(BuildContext context) {
    ...
    // 優先使用傳入的 overrideSentiment，若無則抓取最後一筆歷史數據
    final String currentSentiment = overrideSentiment ?? displayHistory.last.sentiment;
    final bool isBearish = currentSentiment.contains("跌");
                      ...
                      return touchedSpots.map((spot) {
                        ...
                        return LineTooltipItem(
                          ...
                          children: [
                            TextSpan(
                              text: formatted,
                              style: TextStyle(color: val >= 0 ? const Color(0xFF00FF9D) : const Color(0xFFFF2E2E), fontSize: 16, fontWeight: FontWeight.w900),
                            ),
                          ],
                        );
                      }).toList();
